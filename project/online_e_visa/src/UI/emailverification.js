...
function EmailSend() {
  ...
  const handleOtp = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://cute-plum-scarab-wrap.cyclic.app/api/emailotp', {
        email: mail,
      });
  ...
  const verifyOtp = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post('https://cute-plum-scarab-wrap.cyclic.app/api/emailotp/verify-otp', {
        otp: vmail,
      });
